...
### Added
- **Default command**: you can now run `video-transcriber interview.mp4` without typing `transcribe`
- **Config file support** (`video-transcriber.toml` or `~/.config/video-transcriber/config.toml`)
  - Set default model, device, format, diarize, skip_existing, etc.
